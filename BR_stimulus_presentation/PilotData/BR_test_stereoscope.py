...
win = visual.Window(allowGUI=False, fullscr=True, units='deg', monitor=monitors.Monitor("MA_533_NEC_FE992")) #fullscr=True, units="deg",
...
leftEyePos = (-10, 0)
rightEyePos = (10, 0)
runRivalry.presentAlignmentStimuliForStereoscope(kb, win, gratingSize, leftEyePos, rightEyePos)
...
fileName =  "s{}_session{}_{}_BRdata_stereoscope.csv".format(subject, session, todaysDate)# subject Number, session date
